...
class ENV:
    ...
    def __init__(self, nb_mec=0, nb_vnfs=0, min_cpu=50, max_cpu=100, min_ram=50, max_ram=100, min_disk=4096,
        ...
        # MECs
        self.min_cpu = 16  # min_cpu
        self.max_cpu = 16  # max_cpu
        self.min_ram = 16  # min_ram
        self.max_ram = 16  # max_ram
        self.min_disk = 8192  # min_disk
        self.max_disk = 8192  # max_disk
        # Containers
        self.min_c_cpu = 2  # min_c_cpu
        self.max_c_cpu = 2  # max_c_cpu
        self.min_c_ram = 2  # min_c_ram
        self.max_c_ram = 2  # max_c_ram
        self.min_c_disk = 512  # min_c_disk
        self.max_c_disk = 512  # max_c_disk
        ...
        self.generate_mec()
        self.generate_vnfs()
        self.end_checker = EndChecker(100)
        self.win = WinningCondition(10)
        self.end = 0
